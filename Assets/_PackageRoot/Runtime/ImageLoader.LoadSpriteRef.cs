...
namespace Extensions.Unity.ImageLoader
{
    public static partial class ImageLoader
    {
        ...
        public static Future<Reference<Sprite>> LoadSpriteRef(string url, Vector2 pivot, TextureFormat textureFormat = TextureFormat.ARGB32, bool ignoreImageNotFoundError = false, CancellationToken cancellationToken = default)
        {
            ...
            // future.Cancelled            (futureRef.Cancel);
...
//         static async void InternalLoadSpriteRef(Future<Reference<Sprite>> future, Vector2 pivot, TextureFormat textureFormat = TextureFormat.ARGB32, bool ignoreImageNotFoundError = false, CancellationToken cancellationToken = default)
//         {
