...
namespace Extensions.Unity.ImageLoader.Tests.Utils
{
    ...
    public partial class FakeFuture<T> : IFuture<T>
    {
        ...
        public IFuture<T> LoadingFromDiskCache(Action action) => throw new NotImplementedException();
        public IFuture<T> LoadingFromSource(Action action) => throw new NotImplementedException();
